...
<body>
    ...
    <div class="toast show call_notification border rounded">
        <div class="toast-header">
            <strong class="mx-2"><i><strong>Incomming From 5816546454</strong></i></strong>
        </div>
        <div class="toast-body">
            <button class="mx-2 btn btn-sm btn-success">Accept</button>
